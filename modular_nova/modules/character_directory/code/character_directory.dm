...
GAME_VERB_DESC(/client, show_character_directory, "角色目录", "Shows a listing of all active characters, along with their associated OOC notes, flavor text, and more.", "OOC", specific_ad as text|null)
