...
/obj/item/clothing/under/costume/playbunny/magician/Initialize(mapload)
	. = ..()
	create_storage(storage_type = /datum/storage/pockets/small/magician)

/datum/storage/pockets/small/magician/New() //this is probably a good idea
	. = ..()
...
/obj/item/clothing/under/rank/cargo/quartermaster_playbunny/Initialize(mapload)
	. = ..()
...
/obj/item/clothing/under/rank/civilian/lawyer_playbunny_good/Initialize(mapload)
	. = ..()
